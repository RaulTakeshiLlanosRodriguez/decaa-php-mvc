            ...
            <div>
                ...
                <ul class="nav flex-column mt-4">
                    <li class="nav-item mb-2">
                        <a class="nav-link <?= ($_GET['section'] ?? '') === 'publicaciones' ? 'bg-white text-danger rounded px-3 py-2' : 'text-white' ?>" href="<?= BASE_URL ?>/admin/publicaciones">
                            <i class="fas fa-book me-2"></i>Investigaciones
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a class="nav-link <?= ($_GET['section'] ?? '') === 'comites' ? 'bg-white text-danger rounded px-3 py-2' : 'text-white' ?>" href="<?= BASE_URL ?>/admin/comites">
                            <i class="fas fa-users me-2"></i>Comités
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a class="nav-link <?= ($_GET['section'] ?? '') === 'indicadores' ? 'bg-white text-danger rounded px-3 py-2' : 'text-white' ?>" href="<?= BASE_URL ?>/admin/indicadores">
